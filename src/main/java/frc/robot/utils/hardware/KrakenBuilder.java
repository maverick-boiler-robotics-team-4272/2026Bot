...
public class KrakenBuilder {
  ...
  /**
   * Reduces CAN traffic for better performance This is already integrated
   *
   * @return itself
   */
  ...
  public KrakenBuilder withInversion(InvertedValue Invertedvalue) {
    config.withMotorOutput(new MotorOutputConfigs().withInverted(Invertedvalue));
    return this;
  }
  ...
  public KrakenBuilder withIdleMode(NeutralModeValue neutralModeValue) {
    config.withMotorOutput(new MotorOutputConfigs().withNeutralMode(neutralModeValue));
    return this;
  }
   ...
   * @return a new KrakenBUilder
   */
  public static KrakenBuilder createWithDefaults(
      int id, String can, String subsystem, String name) {
