...
public class SubsystemConstants {
  ...
  public static class ShooterConstants {
    ...
    public static final InterpolatingDoubleTreeMap SHOOTER_VELOCITY_LOOKUP = InterpolatingDoubleTreeMap.ofEntries(Map.entry(3.11, 50.0), Map.entry(3.32, 52.0), Map.entry(3.85, 55.0), Map.entry(4.21, 57.0), Map.entry(5.09, 70.0));
    public static final InterpolatingDoubleTreeMap SCORE_ANGLE_LOOKUP = InterpolatingDoubleTreeMap
        .ofEntries(Map.entry(3.11, 0.015), Map.entry(3.32, 0.0175), Map.entry(3.85, 0.022), Map.entry(4.21, 0.025), Map.entry(5.09, 0.0325));
