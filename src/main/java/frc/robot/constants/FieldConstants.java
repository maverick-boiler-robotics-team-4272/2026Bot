...
public class FieldConstants {
  ...
  public static final Translation2d LEFT_TRENCH_TO_NEUTRAL_ZONE_OUT =
      new Translation2d(
          isRedSide() ? 6 : FIELD_LENGTH_M - 6,
          isRedSide() ? FIELD_WIDTH_M - 0.5 : 0.5); // TODO: I need actual numbers for this
  public static final Translation2d RIGHT_TRENCH_TO_NEUTRAL_ZONE_OUT =
      new Translation2d(
          isRedSide() ? 1 : FIELD_LENGTH_M - 1,
          isRedSide() ? 0.5 : FIELD_WIDTH_M - 0.5); // TODO: I need actual numbers for this
  public static final Translation2d LEFT_TRENCH_TO_NEUTRAL_ZONE_IN =
      new Translation2d(
          isRedSide() ? 6 : FIELD_LENGTH_M - 6,
          isRedSide() ? FIELD_WIDTH_M - 0.5 : 0.5); // TODO: I need actual numbers for this
  public static final Translation2d RIGHT_TRENCH_TO_NEUTRAL_ZONE_IN =
      new Translation2d(
          isRedSide() ? 6 : FIELD_LENGTH_M - 6,
          isRedSide() ? 0.5 : FIELD_WIDTH_M - 0.5); // TODO: I need actual numbers for this
