...
public class FieldConstants {
    ...
    public static final Pose2d TRENCH_LEFT_OUT_APPROACH = new Pose2d(13.265, 0.657, Rotation2d.kZero);

    public static final Pose2d TRENCH_LEFT_OUT = new Pose2d(12.568, 0.657, Rotation2d.kZero);

    public static final Pose2d TRENCH_LEFT_IN = new Pose2d(11.210, 0.657, Rotation2d.kZero);

    public static final Pose2d TRENCH_LEFT_IN_APPROACH = new Pose2d(10.4, 0.657, Rotation2d.kZero);

    public static final Pose2d TRENCH_RIGHT_OUT_APPROACH = new Pose2d(13.265, FIELD_WIDTH_M - 0.657,
            Rotation2d.kZero);
    public static final Pose2d TRENCH_RIGHT_OUT = new Pose2d(12.568, FIELD_WIDTH_M - 0.657, Rotation2d.kZero);
    public static final Pose2d TRENCH_RIGHT_IN = new Pose2d(11.210, FIELD_WIDTH_M - 0.657, Rotation2d.kZero);
    public static final Pose2d TRENCH_RIGHT_IN_APPROACH = new Pose2d(10.4, FIELD_WIDTH_M - 0.657, Rotation2d.kZero);
