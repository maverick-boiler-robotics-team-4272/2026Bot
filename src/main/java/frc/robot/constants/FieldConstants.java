...
public class FieldConstants {
  ...
  public static final Pose2d TRENCH_LEFT_OUT_APPROACH = new Pose2d(isRedSide() ? FIELD_WIDTH_M - 7.4125 : 7.4125,
      isRedSide() ? FIELD_LENGTH_M - 3.03 : 3.03, Rotation2d.fromDegrees(180));
  public static final Pose2d TRENCH_LEFT_OUT = new Pose2d(isRedSide() ? FIELD_WIDTH_M - 7.4125 : 7.4125,
      isRedSide() ? FIELD_LENGTH_M - 4.03 : 4.03, Rotation2d.fromDegrees(180));
  public static final Pose2d TRENCH_LEFT_IN = new Pose2d(isRedSide() ? FIELD_WIDTH_M - 7.4125 : 7.4125,
      isRedSide() ? FIELD_LENGTH_M - 5.128 : 5.128, Rotation2d.fromDegrees(180));
  public static final Pose2d TRENCH_LEFT_IN_APPROACH = new Pose2d(isRedSide() ? FIELD_WIDTH_M - 7.4125 : 7.4125,
