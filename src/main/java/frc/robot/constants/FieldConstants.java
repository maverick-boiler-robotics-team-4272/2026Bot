...
public class FieldConstants {
        ...
        // ? 13.265 : FIELD_LENGTH_M - 13.265,
        // isRedSide() ? 0.657 : FIELD_WIDTH_M - 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);

        // public static final Pose2d TRENCH_LEFT_OUT = new Pose2d(isRedSide() ? 12.568
        // : FIELD_LENGTH_M - 12.568,
        // isRedSide() ? 0.657 : FIELD_WIDTH_M - 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);

        // public static final Pose2d TRENCH_LEFT_IN = new Pose2d(isRedSide() ? 11.210 :
        // FIELD_LENGTH_M - 11.210,
        // isRedSide() ? 0.657 : FIELD_WIDTH_M - 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);

        // public static final Pose2d TRENCH_LEFT_IN_APPROACH = new Pose2d(isRedSide() ?
        // 10.4 : FIELD_LENGTH_M - 10.4,
        // isRedSide() ? 0.657 : FIELD_WIDTH_M - 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);

        // public static final Pose2d TRENCH_RIGHT_OUT_APPROACH = new Pose2d(
        // isRedSide() ? 13.265 : FIELD_LENGTH_M - 13.265, isRedSide() ? FIELD_WIDTH_M -
        // 0.657 : 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);
        // public static final Pose2d TRENCH_RIGHT_OUT = new Pose2d(isRedSide() ? 12.568
        // : FIELD_LENGTH_M - 12.568,
        // isRedSide() ? FIELD_WIDTH_M - 0.657 : 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);
        // public static final Pose2d TRENCH_RIGHT_IN = new Pose2d(isRedSide() ? 11.210
        // : FIELD_LENGTH_M - 11.210,
        // isRedSide() ? FIELD_WIDTH_M - 0.657 : 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);
        // public static final Pose2d TRENCH_RIGHT_IN_APPROACH = new Pose2d(isRedSide()
        // ? 10.400 : FIELD_LENGTH_M - 10.400,
        // isRedSide() ? FIELD_WIDTH_M - 0.657 : 0.657,
        // isRedSide() ? Rotation2d.kZero : Rotation2d.k180deg);

        // public static final Pose2d[] LEFT_OUT = { TRENCH_LEFT_OUT_APPROACH,
        // TRENCH_LEFT_OUT, TRENCH_LEFT_IN,
        // TRENCH_LEFT_IN_APPROACH };
        // public static final Pose2d[] LEFT_IN = { TRENCH_LEFT_IN_APPROACH,
        // TRENCH_LEFT_IN, TRENCH_LEFT_OUT,
        // TRENCH_LEFT_OUT_APPROACH };
        // public static final Pose2d[] RIGHT_OUT = { TRENCH_RIGHT_OUT_APPROACH,
        // TRENCH_RIGHT_OUT, TRENCH_RIGHT_IN,
        // TRENCH_RIGHT_IN_APPROACH };
        // public static final Pose2d[] RIGHT_IN = { TRENCH_RIGHT_IN_APPROACH,
        // TRENCH_RIGHT_IN, TRENCH_RIGHT_OUT,
