...
public class VisionConstants {
  ...
  public static final Transform3d CAMERA_A_TRANSFORM =
      new Transform3d(
          Units.inchesToMeters(12.318), // x
          Units.inchesToMeters(-12.627), // y
          Units.inchesToMeters(16.553), // z
          new Rotation3d(0 /*roll*/, 0 /*pitch*/, 90 /*yaw*/)); // Right side
  public static final Transform3d CAMERA_B_TRANSFORM =
      new Transform3d(
  ...
  public static final Matrix<N3, N1> SINGLE_TAG_STD_DEVIATIONS =
      VecBuilder.fill(0.5, 0.5, 3.14159265358979323846264338327950288419716939937901);
