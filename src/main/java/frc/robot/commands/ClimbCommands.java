...
public class ClimbCommands {
  // public static Command driveThenClimbCommand(CommandSwerveDrivetrain drive,
  // Climber climber, Intake intake,
  // BooleanSupplier ready) {
  // return new ParallelCommandGroup(
  // drive.defer(() ->
  // drive.pidToPoint(drive.getState().Pose.nearest(CLIMB_POSES))),
